          ...
          <div className="flex justify-center flex-col">
            <div className="flex justify-center ">
              <Link
                onClick={handleClose}
                to={"/"}
                className="p-2.5 flex mt-3 items-center rounded-md px-4 duration-300 cursor-pointer text-center navItem w-2/3"
              >
                <i className=" text-sm"></i>
                <svg
                  width="24"
            ...
            <div className="flex justify-center ">
              <Link
                onClick={handleClose}
                to={"student-creation"}
                className="p-2.5 flex mt-3 items-center rounded-md px-4 duration-300 cursor-pointer navItem w-2/3 text-center"
              >
                <i className=" text-sm"></i>
                <svg
                  width="24"
